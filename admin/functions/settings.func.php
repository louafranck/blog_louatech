...
function add_modo($name,$email,$role,$token){
    ...
    $message = '
        <html lang="fr" style="font-family: sans-serif;">
            ...
            <body>
                Voici votre identifiant et code unique à insérer sur <a href="http://localhost:8080/blog_Ma/admin/index.php?page=new">cette page</a>:
    ...
    $header .= 'From: gfranckloua27@gmail.com' . "\r\n" . 'Reply-To: contact@nicwalle.com' . "\r\n" . 'X-Mailer: PHP/' . phpversion();
